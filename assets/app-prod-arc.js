    ...
    */
    ...
    (function() {
        ...
        */
        ...
        function ug(a, b, c) {
            return "http://web.archive.org/web/20130304052657im_/https://i.ytimg.com/" + b + "/" + a + "/" + c + ".jpg";
        }
        ...
        function Cg(a) {
            ...
            this.dQ = {
                ...
                STrecently_featured: "icon-related"
            };
        ...
        d.fL = function() {
            this.qj ? this.Zf() : yd("html5-video-player") ? (this.qj = !0, this.Zf()) : this.lC.get("/leanback.json", {
        ...
        d.bx = function(a, b, c) {
            if (!this.oa || 2 != this.oa.Vc()) {
                ...
                this.Zh = b || 0;
                a = this.kw + "/test";
                b = "https://youtube.com/api/lounge/bc/bind";
