...
var ta = "setData", ua = "appendChild", s = "push", va = "stop", u = "toString", v = "length", wa = "getBoundingClientRect", xa = "plugins", ya = "create", w = "prototype", za = "test", Aa = "exec", Ba = "clearTimeout", y = "width", Ca = "index", Da = "clientWidth", Ea = "abort", Fa = "slice", Ga = "setTimeout", z = "replace", Ha = "nodeType", Ia = "document", Ja = "ceil", Ka = "load", A = "split", La = "floor", Ma = "getElementById", Na = "offsetWidth", Oa = "createTextNode", C = "stopPropagation", Pa = "value", Qa = "location", D = "indexOf", Ra = "message", Sa = "hasOwnProperty", E = "dispatchEvent", F = "style", Ta = "capture", Ua = "body", Va = "write", G = "view", Wa = "removeChild", Ya = "parent", Za = "target", $a = "screenX", ab = "screenY", bb = "lastChild", H = "call", cb = "getBoxObjectFor", db = "send", eb = "innerHeight", fb = "remove", gb = "some", hb = "start", ib = "focus", jb = "createElement", I = "setProperty", kb = "keyCode", lb = "firstChild", mb = "forEach", pb = "clientHeight", qb = "charCodeAt", rb = "substring", sb = "handleEvent", tb = "addVariable", J = "type", ub = "every", vb = "contains", wb = "apply", xb = "clear", yb = "childNodes", zb = "defaultView", Ab = "navigator", Bb = "name", Cb = "parentNode", Db = "offsetTop", Eb = "contentWindow", K = "height", Fb = "splice", Gb = "offsetHeight", Hb = "join", Ib = "unshift", Jb = "documentElement", Kb = "substr", M, Lb = Lb || {}, N = this, Nb = function(a, b, c) {
    var d = a[A]("."), f = c || N, g;
    ...
    for (; f = c.shift(); )
        if (d[f])
            ...
            return i;
    return d
}, Pb = function() {}, Qb = function(a) {
    var b = typeof a;
    if (b == "object")
        if (a) {
            if (a instanceof o || !(a instanceof ba) && ba[w][u][H](a) == "[object Array]")
                return "array";
...
var cc = function(a, b, c) {
  ...
  , fc = function(a, b, c, d) {
    if (a.reduce)
        return d ? a.reduce(Zb(b, d), c) : a.reduce(b, c);
    var f = c;
    S(a, function(g, h) {
        f = b[H](d, f, g, h, a)
    });
...
var T = function(a, b, c) {
  ...
  , xc = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"]
  , yc = function(a) {
    var b, c, d = 1;
    for (; d < arguments[v]; d++) {
        c = arguments[d];
...
M.fh = function(a) {
    if (a > this.ib)
        l(m("[goog.structs.SimplePool] Initial cannot be greater than max"));
    var b = 0;
    for (; b < a; b++)
        this.ha[s](this.qb())
}
...
M.Tc = function(a, b) {
    ...
    this.keyCode = a[kb] || 0;
    this.charCode = a.charCode || (this[J] == "keypress" ? a[kb] : 0);
...
M.Tc = function(a, b, c, d, f, g) {
    if (Tb(a))
        this.be = k;
    else if (a && a[sb] && Tb(a[sb]))
        this.be = e;
    else
        l(m("Invalid listener argument"));
    this.hb = a;
    this.$f = b;
    this.src = c;
    oa(this, d);
...
M.handleEvent = function(a) {
    if (this.be)
        return this.hb[H](this.Wb || this.src, a);
...
var wd = function() {
    ...
    if (b)
        if (O(b)) {
            ...
            if (a.addEventListener) {
                if (a == N || !a.af)
                    a.addEventListener(b, x, h)
            } else
                a.attachEvent(Ad(b), x);
            return B
        }
    else
        l(m("Invalid event type"))
}
  ...
  , Ed = function(a) {
    ...
    if (c.removeEventListener) {
        if (c == N || !c.af)
            c.removeEventListener(d, f, g)
    } else
        c.detachEvent && c.detachEvent(Ad(d), f);
    var h = Xb(c)
      , j = od[d][g][h];
    if (pd[h]) {
        var p = pd[h];
  ...
  , td = function(a, b) {
    ...
    if (V) {
        var h = b || Ob("window.event")
          , j = k in f;
        if (j) {
            if (h[kb] < 0 || h.returnValue != undefined)
                return k;
            Nd(h)
        }
        Xb(c.src);
...
M.ij = function() {
    if (this.enabled) {
        var a = ac() - this.he;
        if (a > 0 && a < this.Oa * 0.8)
            this.v = this.lc[Ga](this.xd, this.Oa - a);
        else {
            this.kh();
            if (this.enabled) {
...
var Rd = function(a, b, c) {
    if (Tb(a)) {
        if (c)
            a = Zb(a, c)
    } else if (a && typeof a[sb] == "function")
        a = Zb(a[sb], a);
    else
        l(m("Invalid listener argument"));
...
;
if ("StopIteration"in N)
    var Vd = N.StopIteration;
else
    Vd = m("StopIteration");
var Wd = function() {};
Wd[w].next = function() {
...
var Zd = function(a) {
  ...
  , ae = function(a, b) {
    if (typeof a[vb] == "function")
        return a[vb](b);
    if (typeof a.Cc == "function")
        return a.Cc(b);
    if (Rb(a) || P(a))
        return ic(a, b);
    return uc(a, b)
...
var ce = function(a) {
    ...
    if (b > 1) {
        if (b % 2)
            l(m("Uneven number of arguments"));
        var c = 0;
        for (; c < b; c += 2)
            this.sa(arguments[c], arguments[c + 1])
    } else
        a && this.sd(a)
};
M = ce[w];
...
M.Nb = function(a) {
    ...
    h.next = function() {
        for (; k; ) {
            if (f != g.qc)
                l(m("The map has changed since the iterator was created"));
            if (b >= c[v])
                l(Vd);
            var j = c[b++];
            return a ? j : d[j]
...
var Ie = bd && Pc(gd, "521") <= 0
  , Je = function(a, b) {
    if (typeof a[vb] != "undefined" && !Ie && b[Ha] == 1)
        return a == b || a[vb](b);
...
M.a = function(a, b, c, d, f) {
    if (O(b)) {
        ...
        this.Ni(zd(a, b, c || this, d || e, f || this.eb || this));
    return this
}
;
M.Ni = function(a) {
...
var pf = function(a, b, c, d) {
    Od[H](this);
    if (a && !b)
        l(m("Can't use invisible history without providing a blank page."));
    var f;
    if (c)
        f = c;
    else {
    ...
    this.Qc = b;
    if (V && !b)
        this.Qc = window[Qa].protocol == "https" ? "https:///" : 'javascript:""';
    this.v = new Qd(150);
    this.Lb = !a;
    this.wa = new mf(this);
    if (a || V) {
...
M.Gb = function(a) {
    if (!(a == this.Hc))
        if (V && !this.Jd)
            ...
            if ($c)
                this.wa.a(this.ab[Ia], qf, this.Ii);
            else
                ad && this.wa.a(this.ab, "pageshow", this.Ai);
            if (!V || this.Jd) {
...
M.jg = function(a) {
    if (this.Xc != a)
        this.v.setInterval(a ? 10000 : 150);
    this.Xc = a
}
;
M.Ii = function() {
...
M.send = function(a, b, c, d) {
    if (this.ka)
        l(m("[goog.net.XhrIo] Object is active with another request"));
    var f = b || "GET";
    this.fe = a;
    this.cc = "";
    this.Ab = 0;
    ...
    f == "POST" && !j.Ea("Content-Type") && j.sa("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
    be(j, function(p, r) {
...
M.Nf = function() {
    if (!!this.ka)
        if (!(typeof Lb == "undefined"))
            if (this.pd[1] && this.Ub() == 4 && this.Oc() == 2)
                this.ja.ta(this.La("Local request error detected and ignored"));
            else if (this.Sc && this.Ub() == 4)
                Pd[Ga](Zb(this.Of, this), 0);
            else {
...
var Jf = function(a, b) {
    ...
    this.ib = b || 10;
    if (this.Ef > this.ib)
        l(m("[goog.structs.Pool] Min can not be greater than max"));
    this.ha = new If;
    this.Ia = new ee;
    this.wc()
};
...
M.o = function() {
    Jf.u.o[H](this);
    if (this.uh() > 0)
        l(m("[goog.structs.Pool] Objects not released"));
...
M.send = function(a, b, c, d, f, g, h, j) {
    if (this.Ba.na(a))
        l(m("[goog.net.XhrManager] ID in use"));
...
(function() {
    ...
    if (!!a)
        if (a[D]("Firefox") != -1)
            Tf = k;
        else if (a[D]("Camino") != -1)
            Uf = k;
        else if (a[D]("iPhone") != -1 || a[D]("iPod") != -1)
            Vf = k;
        else if (a[D]("Android") != -1)
            Wf = k;
        else if (a[D]("Chrome") != -1)
            Xf = k;
        else if (a[D]("Safari") != -1)
            Yf = k
}
)();
var Zf = Uf;
...
var gg = function(a) {
  ...
  , ig = function(a) {
    ...
    for (; f && f != b; f = f[Cb]) {
        ...
        if (!d && (f.scrollWidth > f[Da] || f.scrollHeight > f[pb] || c == "fixed" || c == "absolute"))
            return f
    }
    return i
}
  , jg = function(a) {
    var b, c = xe(a), d = eg(a, "position"), f = ad && c[cb] && !a[wa] && d == "absolute" && (b = c[cb](a)) && (b[$a] < 0 || b[ab] < 0);
    if (typeof $f == "undefined")
        $f = Zf && !(Pc(gd, "1.8.0.11") >= 0);
    var g = new ne(0,0)
      , h = gg(c);
    if (a == h)
        return g;
  ...
  , lg = function(a) {
    if (eg(a, "display") != "none")
        return $c ? new oe(a[Na] || a[Da],a[Gb] || a[pb]) : new oe(a[Na],a[Gb]);
    var b = a[F]
      , c = b.display
      , d = b.visibility
      , f = b.position;
...
M.Ta = function() {
    if (this.Ph)
        l(m("Tried to modify a read-only Uri"))
}
;
M.Ib = function(a) {
    this.Ha = a;
...
pc = function(a, b, c) {
    if (a[Fa])
        return arguments[v] <= 2 ? a[Fa](b) : a[Fa](b, c);
    b || (b = 0);
    var d = a[v];
    if (c)
        d = c;
...
var rh = /\s*;\s*/
  , sh = function(a, b, c, d, f) {
    if (/[;=]/[za](a))
        l(m('Invalid cookie name "' + a + '"'));
    if (/;/[za](b))
        l(m('Invalid cookie value "' + b + '"'));
    Mb(c) || (c = -1);
    var g = f ? ";domain=" + f : "", h = d ? ";path=" + d : "", j;
    if (c < 0)
        j = "";
    else if (c == 0)
        j = ";expires=" + (new Date(1970,1,1)).toUTCString();
    else {
  ...
  , th = function(a, b) {
    var c = a + "=", d = n(fa.cookie)[A](rh), f = 0, g;
    for (; g = d[f]; f++)
        if (g[D](c) == 0)
            return g[Kb](c[v]);
    return b
...
(function() {
    ...
    if (ca[xa] && ca[xa][v]) {
        ...
        if (b = f && f.enabledPlugin)
            c = a(f.enabledPlugin.description)
    } else
        try {
        ...
        if (this.Vc()) {
            ...
            if (h["return"] != 0) {
                ...
                if (!Sb(j) || !Sb(p) || !O(r) || j - 1 > f) {
                    ...
                    S(d.n.keywords, function(B, L, ra) {
                        ra[L] = Mc(B, "<b>");
                        ra[L] = Mc(ra[L], "</b>")
                    });
...
M.Fh = function(a, b, c, d, f) {
    if (!!this.w) {
        ...
        if (this.fa != 0 && this.fa >= this.Ga())
            ...
            h--;
            for (; h >= j; --h)
                this.Ud(h - this.fa, h, i);
            if (a == 0) {
                this[G]()[I]("keywords", f);
                for (; g < j; ++g)
                    this.Ud(g - this.fa, g, d[g]);
                this[E](this.Fd, X);
                this[E](this.Ob, W)
            } else {
                for (; g < j; ++g)
...
Kh[w].pf = function() {
    ...
    if (c = a.d("video_id", ""))
        b += "&video_id=" + c;
    if (c = a.d("playlist_id", ""))
        b += "&playlist_id=" + c;
    if (c = a.d("user", ""))
        b += "&user=" + c;
    if (c = a.d("query", ""))
        b += "&vq=" + Ec(c);
    if (c = a.d("racy", $.filterRacyContent ? "exclude" : "include"))
        b += "&racy=" + c;
    if ($.app)
        b += "&app=" + $.app;
    if ($.client)
...
var Uh = function(a, b, c) {
    ...
    Th = this;
    if (this.ob())
        this.wj(d, this.h("player_video_properties", {}), h, "swfPipeReceiver", "watchEventPipe");
    else {
        this.Fa = ye();
...
var hh = function(a) {
    if (!a)
        l("Node not found");
    if (!a.id)
        l("Node does not have an id");
    if (!a[Lg])
        l("Node does not have an associated DNA model");
    this.ga = a
};
M = hh[w];
M.c = function() {
    ...
    g: function(a) {
        ...
        if (Sb(b)) {
            ...
            var c = a.c()
              , d = 1;
            for (; d <= b + 0.25; ++d) {
                c[yb][d - 1].src = "http://s.ytimg.com/yt/img/tv/yttv-starfull-vfl58814.png";
                if (d >= 5)
                    return
            }
            if (b + 0.75 >= d) {
                c[yb][d - 1].src = "http://s.ytimg.com/yt/img/tv/yttv-starhalf-vfl58814.png";
                ++d
            }
            for (; d <= 5; ++d)
                c[yb][d - 1].src = "http://s.ytimg.com/yt/img/tv/yttv-starempty-vfl58814.png"
        } else
            a.z(e)
    }
};
    ...
    if (!(!a.mc || !xi)) {
        ...
        if (!!b) {
            ...
            if (f) {
                ...
                Wg(a.mc, " : View not found for browser history")
        }
    }
};
var Ai = function(a, b, c) {
    ...
    g: function(a) {
        ...
        if (b == 0) {
            ...
            var h = b[u]()
              ...
              , p = d[u]();
            if (d > c)
                d < 10000 ? a[I]("label", Ac("%s - %s %s %s%s", j, p, f, h, g)) : a[I]("label", Ac("%s+ %s %s%s", j, f, h, g));
            else
                a[I]("label", Ac("%s %s %s%s", j, f, h, g));
            Ui.g(a)
        }
    }
};
...
var Xi = Xi || {}
  ...
  , $i = function(a) {
    var b = function(c, d, f) {
        var g = c._CLASS;
        if (!g)
            l(U(f.id, " : Expecting valid control name for key '_CLASS'"));
        if (!Qg[g])
            l(U(f.id, " : Control ", g, " is not defined"))
    };
    Yi(a, function(c) {
        var d = c[G]._CLASS;
        if (!d)
            l(U(c.id, " : Expecting valid view name for key '_CLASS'"));
        var f = Pg[d];
        if (f) {
            if (!f.Da)
                l(U(c.id, " : View ", d, " must have method 'synthesize'"));
            if (!f.g)
                l(U(c.id, " : View ", d, " must have a function 'update'"))
        }
        if (c[G][Ig] && !Ub(c[G][Ig]))
            l(U(c.id, " : Invalid subview record"));
        Zi(c, b)
    })
}
  , aj = function(a, b, c, d) {
    ...
    Yi(a, i, function(g) {
        ...
        var r = p.Da(g);
        if (!(Ub(r) && r[Ha] > 0))
            l(U(g.id, " : 'synthesize' must return a valid DOM node"));
        S(g.Ye(), function(x) {
            r[ua](x)
        });
        h._CLASS = p;
  ...
  , bj = function(a, b, c) {
    var d = c.ia()
      , f = a._CLASS;
    if (!P(f))
        l(U(d, " : Unable to create controls"));
    var g = Qg[f];
    if (!g)
        l(U(d, " : Control ", f, " not defined"));
    var h = new g(b,a,c);
    Og[d] || (Og[d] = []);
    Og[d][s](h)
}
  , cj = function(a, b, c, d) {
    ...
    S(g, function(p) {
        var r = p.ia();
        if (Og[r])
            l(U(r, " : There are already controls associated with this view"));
        var t = p.c()[Lg][Jg];
        O(t) ? S(t, function(x) {
            bj(x, f, p)
        }) : bj(t, f, p)
  ...
  , fj = function(a) {
    ...
    Yi(a, function(g) {
        c[g.id] = d++;
        b[s](U("  ", c[g.id], ' [label="', g[G]._CLASS, '"];\n'));
        if (g.Tf)
            b[s](U("  ", c[g.Tf], " -> ", c[g.id], ' [label="', g[Ca] > 0 ? g.pa + "-" + g[Ca] : g.pa, '"];\n'));
        Zi(g, f)
    });
    b[s]("}\n");
    return U[wb](i, b)
  ...
  , gj = function(a, b) {
    ...
    if (c) {
        ...
        Wg("syn.dna.dispatchEvent: Cannot find view ", a)
}
  , hj = function(a, b, c) {
    var d = fa[Ma](a);
    if (d) {
        ...
        Wg("syn.dna.setProperty: Cannot find view ", a)
};
Q("goog.now", ac);
Q("syn.dna.toDot", fj);
Q("syn.dna.render", cj);
